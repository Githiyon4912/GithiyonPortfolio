    ...
    <>
      ...
      >
        ...
        <div className="w-11/12 lg:w-4/5 px-6 relative overflow-hidden z-10">
          <div
            className={`text-center mb-16 transition-all duration-1000 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <div
                className={`pt-8 transition-all duration-1000 delay-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
              >
              ...
              <div className="bg-slate-900 p-8 rounded-2xl border border-slate-700 hover:border-green-500/50 transition-all duration-300">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="group">
                      <label className="text-sm text-white font-semibold mb-2 block group-hover:text-green-400 duration-300 transition-all">
                        Full Name
                      </label>
                      <input
                        type="text"
                        ...
                        required
                        className="w-full rounded-lg px-4 py-3 text-white bg-slate-800 border border-slate-700 group-hover:border-green-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-green-500 placeholder:text-gray-400"
                      />
                    </div>
                    <div className="group">
                      <label className="text-sm text-white font-semibold mb-2 block group-hover:text-green-400 duration-300 transition-all">
                  ...
                  <div className="group mt-6">
                    ...
                    <textarea
                      ...
                      required
                      className="w-full rounded-lg px-4 py-3 text-white resize-none min-h-28 bg-slate-800 border border-slate-700 group-hover:border-green-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-green-500 placeholder:text-gray-400"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full px-8 py-4 mt-6 bg-green-600 text-white text-base rounded-lg flex items-center justify-center gap-2 uppercase cursor-pointer transition-all duration-300 hover:bg-green-700 hover:scale-105 group disabled:opacity-60 disabled:cursor-not-allowed"
                  >
